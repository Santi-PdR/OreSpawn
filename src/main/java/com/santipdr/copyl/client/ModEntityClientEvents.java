...
public final class ModEntityClientEvents {
    ...
    public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(BrutalflyModel.LAYER_LOCATION, BrutalflyModel::createBodyLayer);
        ...
        event.registerLayerDefinition(KyuubiModel.LAYER_LOCATION, KyuubiModel::createBodyLayer);
        ...
        event.registerLayerDefinition(VelocityRaptorModel.LAYER_LOCATION, VelocityRaptorModel::createBodyLayer);
    }
    @SubscribeEvent
