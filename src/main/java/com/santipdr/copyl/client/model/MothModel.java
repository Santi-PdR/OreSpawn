...
/** ModelButterfly original reutilizado por RenderMoth con wingspeed 0.6. */
public final class MothModel extends EntityModel<MothEntity> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(new ResourceLocation(CopyL.MOD_ID, "moth"), "main");
    ...
    @Override
    public void setupAnim(MothEntity entity, float limbSwing, float limbSwingAmount,
